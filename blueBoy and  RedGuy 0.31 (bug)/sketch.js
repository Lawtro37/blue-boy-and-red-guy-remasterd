...
function draw() {
    ...
    if(scene == 5){
        ...
        fill("red")
        rect(width / 2.3, 0, 20, height/2+20)
        ...
        fill("red")
        rect(width / 1.8, height/2.8, 20, height/4+20)
...
function level4f() {
    ...
    for(i = 1, i >= 5; i++;)
    {
        var box = Bodies.rectangle(width / 0.7, height - 50 + i*50, 50, 20, { isStatic: true })
        boxes.push(box)
        World.add(world, boxes[i-1])
    }
}
